...
<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
  <link rel="stylesheet" href="app.css?v=1773017911">
  ...
  <div class="app-body">
    ...
    <div class="page" id="page-balance">
      <div class="flex-between mb-3">
        <div>
          <div class="page-title">⚖️ 밸런스 비교</div>
          <div class="page-sub">참석자 RP 기반 균형 배분</div>
        </div>
        <button onclick="balReset()" style="font-size:.74rem;padding:4px 12px;background:var(--bg2);border:1px solid var(--border);border-radius:8px;cursor:pointer;color:var(--text-muted);">🔄 초기화</button>
      </div>
      ...
      <div id="bal-step1">
        <div class="card mb-3">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
            <div style="font-size:.85rem;font-weight:700;">참석자 선택</div>
            <div id="bal-attendee-count" style="font-size:.74rem;color:var(--text-muted);">0명 선택됨</div>
          </div>
          <div id="bal-attendee-list" style="display:flex;flex-wrap:wrap;gap:5px;min-height:50px;background:var(--bg2);border-radius:10px;padding:10px;margin-bottom:10px;">
            <div style="color:var(--text-muted);font-size:.8rem;">불러오는 중…</div>
          </div>
        ...
        <!-- 듀오전 페어 구성 -->
        <div id="bal-duo-section" style="display:none;" class="card mb-3">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">
            <div style="font-size:.85rem;font-weight:700;">파트너 구성</div>
        ...
        <!-- 팀장전 팀장 지정 (숨김) -->
        <div id="bal-captain-section" style="display:none;"></div>

        <button class="btn btn-primary" style="width:100%;padding:12px;font-size:.9rem;" onclick="balGenerate()">⚖️ 밸런스 분석</button>
      </div>

      <!-- STEP 2: 결과 + 수정 -->
      <div id="bal-step2" style="display:none;">
        <div class="card mb-3">
          <div id="bal-gauge"></div>
        </div>
        <div id="bal-edit" class="mb-3"></div>
        <div style="display:flex;gap:8px;">
          <button class="btn btn-ghost" style="flex:1;" onclick="balGoStep(1)">← 다시</button>
          <button class="btn btn-primary" style="flex:1;" onclick="balSave()">💾 저장</button>
        </div>
      </div>
    </div>
...
<script src="app.js?v=1773018288" defer></script>
